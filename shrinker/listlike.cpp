...
VectorShrinker::shrinkable_t VectorShrinker::shrinkMid(shared_ptr<vector<Shrinkable<T>>> shrinkableCont, size_t minSize, size_t frontSize, size_t rearSize) {
...
VectorShrinker::shrinkable_t VectorShrinker::shrinkFrontAndThenMid(shared_ptr<vector<Shrinkable<T>>> shrinkableCont, size_t minSize, size_t rearSize) {
