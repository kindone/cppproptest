...
// INSTANTIATE_FOR_ALL_BASIC_TYPES(template class PROPTEST_API PROPTEST_SHRINKABLE_VECTOR);
// INSTANTIATE_FOR_ALL_BASIC_TYPES(template class PROPTEST_API PROPTEST_SHRINKABLE_LIST);
